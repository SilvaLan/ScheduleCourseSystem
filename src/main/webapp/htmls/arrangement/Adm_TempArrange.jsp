                    ...
                    <div class="container">
                            ...
                            <div class="container-fluid">
                                ...
                                <div>
                                    <form class="navbar-form navbar-right" role="Search">
                                        ...
                                        <button type="submit" class="btn .btn-default">搜索空教室</button>
                                    </form>
                                </div>
                            </div>
                        </nav>
                        ...
                        <table class="table table-hover" >
                            ...
                            <tr>
                                ...
                                <td>---</td>
                                <td>---</td>
                                <td><input type="radio" name="xuanze" ></td>
                            </tr>
                            <tr>
                                <td>---</td>
                                <td>---</td>
                        ...
                        <form class="navbar-right">
                            <input  align="right" type="submit" class="btn btn-default" onclick="myfunction()" value="添加活动"/>
                        </form>
                    </div>
                </div>
            </div>
